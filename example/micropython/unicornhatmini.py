...
BUTTON_A = Pin_bcm.BCM5
BUTTON_B = Pin_bcm.BCM6
BUTTON_X = Pin_bcm.BCM16
BUTTON_Y = Pin_bcm.BCM24
...
class UnicornHATMini():
    ...
    def __init__(self, spi_max_speed_hz=600000):
        ...
        self.left_matrix = (SPI(0, baudrate=spi_max_speed_hz), Pin_bcm.BCM8, 0)
        self.right_matrix = (SPI(0, baudrate=spi_max_speed_hz), Pin_bcm.BCM7, 28 * 8)
...
if __name__ == "__main__":
    ...
    for b in [BUTTON_A, BUTTON_B, BUTTON_X, BUTTON_Y]:
        buttons.append(Pin(b, machine.Pin.IN, machine.Pin.PULL_UP))
    p = ((1, 1), (1, 5), (15, 1), (15, 5))
